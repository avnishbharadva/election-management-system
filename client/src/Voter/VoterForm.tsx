...
import { NumberField, NameField, EmailField, GenderField, DateOfBirthField, FirstVotedYear,  StatusField, FormImage, ManuItemComponet, HasVotedBefore } from '../Helpers/FormFields';
        ...
        <Container>
          ...
          <VotingInfo>
            ...
            <FormRowWide>
              ...
              <ManuItemComponet label='Party' name="party" control={control} data={Party?.data} idKey='partyId' valueKey='partyName' displayKey='partyName'  loading={PartyLoading} isError={PartyIsError} error={PartyError} />
          ...
          <AddressField>
            ...
            <FormRowWide>
              ...
              <NameField label="City" name="residentialAddress.city" control={control} />
               <ManuItemComponet  label='County' name="residentialAddress.county" control={control} data={county?.data} idKey='countyId' valueKey='countyName' displayKey='countyName'  loading={countyLoading} isError={countyIsError} error={countyError} />
               <ManuItemComponet  label='Town' name="residentialAddress.town" control={control} data={town?.data} idKey='townId' valueKey='townName' displayKey='townName'  loading={townLoading} isError={townIsError} error={townError} />
          ...
          {!sameAddress && (
            <AddressField>
              ...
              <FormRowWide>
                ...
                <ManuItemComponet  label='County' name="mailingAddress.county" control={control} data={county?.data} idKey='countyId' valueKey='countyName' displayKey='countyName'  loading={countyLoading} isError={countyIsError} error={countyError} />
               <ManuItemComponet  label='Town' name="mailingAddress.town" control={control} data={town?.data} idKey='townId' valueKey='townName' displayKey='townName'  loading={townLoading} isError={townIsError} error={townError} />
